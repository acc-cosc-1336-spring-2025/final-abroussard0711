...
def main ():
    ...
    while True:
        ...
        while not question_c.validate_dna_string1 (dna_string1):
        ...
        while not question_c.validate_dna_string2 (dna_string2):
        ...
        results = question_c.get_most_likely_ancestor_consensus (dna_string1, dna_string2)
